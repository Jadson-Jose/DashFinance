    ...
    dbc.Row([
        ...
        dbc.Col([
            ...
            dbc.CardGroup([
                ...
                dbc.Card([
                    html.Legend("Saldo"),
                    html.H5('R$ 54000', id='p-saldo-dashboards', style={})
                ], style={'padding-left': "20px", 'padding-top': '10px'}),

                dbc.Card(
                    html.Div(className='fa fa-university', style=card_icon),
                    color='warning',
                    style={'maxWidth': 75, 'heigth': 100, "margin-left": '-100px'}    
                )
            ])
        ], width=4),
        ...
        dbc.Col([
            ...
            dbc.CardGroup([
                ...
                dbc.Card([
                    html.Legend("Receita"),
                    html.H5("R$ 0000", id='receita-dashboards'),
                ], style={"padding-left": "20px", "padding-top": "10px",}),
        ...
        dbc.Col([
            ...
            dbc.CardGroup([
                ...
                dbc.Card([
                    ...
                    html.H5("R$ 2222", id="p-despesa-dashboards"),
                ], style={"padding-left": "20px", "padding-top" : "10px"}),
